...
makeStackedLearner = function(id = "stack", method = "stack.nocv", base.learners, 
  ...
  assertChoice(method, c("average", "stack.cv", "hill.climb"))
  ...
  if (method %in% "stack.cv" & is.null(super.learner))
